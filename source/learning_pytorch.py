...
model_savefile = "./q-learning_model.pth"
save_model = False
load_model = True
skip_learning = True

# Configuration file path
config_file_path = "../wads/my_way_home.cfg"
...
class DQNAgent:
    def __init__(self, action_size, memory_size, batch_size, discount_factor, 
                 lr, load_model, epsilon=0.5, epsilon_decay=0.9996, epsilon_min=0.1):
